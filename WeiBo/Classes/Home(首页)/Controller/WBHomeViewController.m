...
- (void)setupNavBarBtn{
    ...
    [titleBtn setImage:[UIImage imageNamed:@"navigationbar_arrow_up_os7"] forState:UIControlStateSelected];
...
- (UITableViewCell *)tableView:(UITableView *)tableView
    ...
    if (cell == nil) {
        ...
        [cell.imageView setImageWithURL:[NSURL URLWithString:iconUrl] placeholderImage:[UIImage imageNamed:@"tabbar_slider"]];
